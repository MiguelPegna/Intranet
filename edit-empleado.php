...
<body>
    ...
    <main class="contenedor main">
        <div class="portada">
            <a href="lista-usuarios.php" class="btn btn-warning">VOLVER A LISTA DE USUARIOS</A>
            <?php
        ...
        <div class="servicios">
            <h2>Modificar Información del usuario: <?php echo $empleado['Apellido_p'] .' '. $empleado['Apellido_m'] .' '. $empleado['Nombre']; ?></h2>
            <form method="post" action="<?php $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
                <div class="servicios2">
                    <div class="tabla">
                        <fieldset>
                            <legend><strong>Info Personal</strong></legend>
                            <div class="celda">
                                <label class="etiqueta" for="nombre">Nombre(s) </label><br/>
                                <input type="text" name="tnombre" value="<?php echo $empleado['Nombre']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="apellidoP">A Paterno</label><br/>
                                <input type="text" name="tap1" value="<?php echo $empleado['Apellido_p']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="apellidoM">A Materno</label><br/>
                                <input type="text" name="tap2" value="<?php echo $empleado['Apellido_m']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="fecha">Fecha Nac:</label><br/>
                                <input type="date" name="tfecha" value="<?php echo $empleado['Fecha_nac']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="rfc">RFC</label><br/>
                                <input type="text" name="trfc" value="<?php echo $empleado['RFC']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="sexo">Sexo</label><br/>
                                <select name="tsexo">
                        ...
                        <fieldset>
                            <legend ><strong>Info de Contacto</strong></legend>
                            <div class="celda">
                                <label class="etiqueta" for="calle">Calle: </label><br/>
                                <input type="text" name="tcalle" value="<?php echo $empleado['Calle']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="colonia">Colonia</label><br/>
                                <input type="text" name="tcol" value="<?php echo $empleado['Colonia']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="cp">CP</label><br/>
                                <input type="text" name="tcp" value="<?php echo $empleado['CP']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="entidad">Entidad</label><br/>
                                <input type="text" name="tentidad" value="<?php echo $empleado['Entidad']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="telefono">Teléfono</label><br/>
                                <input type="text" name="ttel" value="<?php echo $empleado['Telefono']; ?>"/>
                            </div>

                            <div class="celda">
                                <label class="etiqueta" for="email">Email</label><br/>
                                <input type="text" name="tmail" value="<?php echo $empleado['Email']; ?>"/>
                            </div>
                        </fieldset>

                        <fieldset>
                            <legend><strong>Info empresa</strong></legend>
                            <div class="celda">
                                <label class="etiqueta" for="sucursal">Sucursal</label><br/>
                                <select name="tsuc">
                            ...
                            <div class="celda">
                                <label class="etiqueta" for="turno">Turno</label><br/>
                                <select name="tturno">
                            ...
                            <div class="celda">
                                <label class="etiqueta" for="depto">Departamento</label><br/>
                                <select name="tdepto">
                            ...
                            <div class="celda">
                                <label class="etiqueta" for="permisos">Nivel de Permisos</label><br/>
                    ...
                    <div class="aside">                   
                        <div class="usuariosOnline caja-aside">
                            <h2>
                                <label class="etiqueta" for="Foto">Foto de perfil</label>
                                <div><img src="<?php echo $empleado['Foto']; ?>" width="310" height="460"></div>
                                <input type="file" name="tfoto" class="btn btn-primary"/></br><br/>
                                

                                
                                <a href="javascript:boton1();" class="btn btn-danger">BORRAR USUARIO</a>
                            </h2>
                        </div>
                    </div>
                </div>
