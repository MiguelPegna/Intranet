<?php
    ...
    $sqlChat="SELECT * FROM mensajes WHERE De='$idUser' AND Estado ='Activo' ORDER BY Id_mensaje desc";
...
<main class="contenedor main">
        <div class="portada">
        <a href="inbox.php" class="btn btn-warning">REGRESAR AL INBOX</a> / <a class="btn btn-primary" href="nuevo-msg.php"> + ESCRIBIR NUEVO MENSAJE</a><br/>
        </div>
        <div class="servicios">
            <div class="nuevomensaje">
                <h2><?php echo $imprimir['Nombre'];?> estos son los mensajes que has enviado. </h2>
            </div>
            <table class="table table-sm table-hover table-bordered"> 
                ...
                <tbody> 
                    ...
                    <?php while($verChat = $chat-> fetch_array(MYSQLI_BOTH)) {  
                        ...
                        $sqlUser="SELECT Id_empleado, Nombre, Apellido_p, Apellido_m, Sucursal, Departamento, Foto FROM usuarios WHERE Id_empleado='".$verChat['Para']."'"; 
