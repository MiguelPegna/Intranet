...
//while para sacar los registros de la tabla usuarios
$arreglo=array();

if($mostrar){
    while($registro = $mostrar-> fetch_array(MYSQLI_BOTH)) { 
        $queryPara="SELECT Id_empleado, Nombre, Apellido_p, Apellido_m, Departamento, Sucursal, Turno FROM usuarios WHERE Nombre= '".$registro['Id_empleado']."'";			           
