...
<div class="contenedor InicioC">
    ...
    <div class="usuario">
        ...
        <img src="<?php echo $imprimir['Foto']; ?>" title="<?php echo $imprimir['Nombre']. " " .$imprimir['Apellido_p']?>" width="42" heigth="42" class="rounded-circle"> <!--style="border-radius:50%"> -->
