        ...
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                ...
                <div class="botones">
                    ...
                    <a href="borrar-producto.php?id=<?php echo $producto['Id_producto'];?>" class="btn-green btn-ok">ACEPTAR</a>
                </div>
            </div> 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                ...
                <div class="botones">
                    <button class="btn-red close" data-bs-dismiss="modal">CANCELAR</button>
                    <button type="submit" class="btn btn-danger btnBorrar" data-dismiss="modal" id="<?php echo $producto['Id_empleado']; ?>">ACEPTAR</button>
                </div>
            </div> 
            <div class="modal-title"></div>
        </div>
